...
<?php
	...
	while ($row_promolist =  mysql_fetch_array ($result_promolist)) 
	{
		...
		$promo_blcode_hash = $promo_blcode;
		$promo_blcode_hash = str_replace(' ', 'a', $promo_blcode_hash);		
		$promo_blcode_hash = str_replace('(', 'y', $promo_blcode_hash);		
		$promo_blcode_hash = str_replace(')', 'z', $promo_blcode_hash);		
		//echo " <br> promo_blcode_hash " . $promo_blcode_hash;
			...
			while ($row_branchlist =  mysql_fetch_array ($result_branchlist)) 
			{
				...
				<div class="panel sub_acc_holder">
					<div class="sub_acc_list_head">
						<h4 class="" data-parent="#<?php print($promo_blcode_hash); ?>" data-toggle="collapse" data-target="#promo<?php print($row_branchlist['plid']); ?>">
					...
					<div class="sub_acc_list_body collapse" id="promo<?php print($row_branchlist['plid']); ?>">
