...
<?php
	...
	*/
	...
	while ($row_contactlist =  mysql_fetch_array ($result_contactlist)) 
	{
		...
		//echo " <br> contact_blcode_hash " . $contact_blcode_hash;
		$contact_blcode_hash = $contact_blcode;
		$contact_blcode_hash = str_replace(' ', 'a', $contact_blcode_hash);		
		$contact_blcode_hash = str_replace('(', 'y', $contact_blcode_hash);		
		$contact_blcode_hash = str_replace(')', 'z', $contact_blcode_hash);		
		//echo " <br> contact_blcode_hash " . $contact_blcode_hash;
