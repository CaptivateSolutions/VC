												...
												<tbody>
													<tr>
														...
														<td align="left" style="border-collapse: collapse; vertical-align: top; line-height: 20px; padding: 0px; margin: 0px; width: 410px;" valign="top">
															...
															We will not be able to refund any payment for no-shows or early check-out.</td>
													</tr>
												</tbody>
											</table>
										</td>
...
$email_title =  "Victoria Court : PayPal Confirmation - Order ID " . $orderid;
...
$headers  = 'MIME-Version: 1.0' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$headers .= 'To: ' . $office_email . "\r\n";
$headers .= 'From: ' . $branch_email . "\r\n";

mail($office_email, $email_title, $message, $headers);
?> 