<?php include 'config8298928293189.php';
	...
	{ 
	  ...
	  $query_update_pay = "UPDATE transaction_list SET tlpaid = tlamt, tltype = 'PAID', tlpaynamics = '$txn_id' WHERE tlid = '$orderid'";
		...
		$trdetails= mysql_query("SELECT * FROM transaction_room WHERE tlid='$tlid'");
		...
		$tldetails= mysql_query("SELECT * FROM transaction_list WHERE tlid='$tlid'");
		...
		//inserted query
		$query2 = 
		"INSERT INTO db161964_vc_reserve.room_reservation_details (
		Reservation_status, 
		Room_Number, 
		Entry_Date, 
		Reserve_Date, 
		...
		echo $rlid, $trdate, $trfrom, $trto, $fname, $lname, $trdays, $trrate, $trstay, $trtime, $tlemail, $tlphone, $txn_id;
		
		$insertdb2=mysql_query($query2) or die(mysqli_error()); 
	} 
