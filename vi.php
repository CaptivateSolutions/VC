<?php include 'config8298928293189.php';
	...
	if ($test_mode == 'YES')
	{
		$txn_id = 'vc7d4e0471df0c959b6325fa4cddfe313bkey';
		$orderid = 1196;  //24 hours stay
	}
	/////////////////////////////// TEST  ////////////////////////////////////
	//$test_mode = 'NO';
...
/* old code
		$query2 = "INSERT INTO db161964_vc_reserve.room_reservation_details (
		Reservation_status, 
		Room_Number, 
		Entry_Date, 
		Reserve_Date, 
...
Cancellations & Modifications for 12 & 24 hours stay should be made 3 days prior check in date. If they cancel beyond 3 days, they will be charged for 1 night. 
	...
	mail($mktg, $email_title, $message, $headers);
		...
		//send to marketing
	$mktg =	'technical@captivategrp.com';
	$headers  = 'MIME-Version: 1.0' . "\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	$headers .= 'To: ' . $mktg . "\r\n";
