<?php 
	/////////// PAYNAMICS RETURN VARIABLE ///////////////
	//http://www.victoriacourt.biz/captivate/index.php?body=paypal_return&mystatus=&requestid=MjA=&responseid=UDEyNjg2NTUyMTYxNTY3MDE2MzQ=
	//requestid=MjA=
	//responseid=UDEyNjg2NTUyMTYxNTY3MDE2MzQ=
	$responseid = '';	
	...
	//echo "<br> responseid is ........  " . $responseid;
	...
	//get booking info if paid already
	$query_company = " 
		SELECT 
			*
		FROM 
	...
	{
		$tlpaynamics = $row_company[tlpaynamics];
		$tltype = $row_company[tltype];
	}	
...
<?php
	if ($tltype != 'PAID') 
	{
    	echo '<h3><a href="index.php?body=room-confirmation" ><span class="fa fa-angle-left"></span> <span class="text">Back</span></a></h3>';
	}
	else
	{
?>
...
<?php
	echo"<h1>Payment Received &amp; Verified</h1>";
	echo"<p>Thank you for your payment. A confirmation voucher has been sent to your  email.</p>";
?>												
                                            </div>
