...
<?PHP
	if ($tltype == 'PAID') 
	{
        ...
        echo"<p>Thank you for your payment. An invoice has been sent to you email.</p>";
	}
	else
	{
		echo"<h1>Payment Unsuccessful</h1>";
        echo"<p>Your payment was unsuccessful, kindly check your payment method and please try again.</p>";
	}
?>												
                                            </div>
