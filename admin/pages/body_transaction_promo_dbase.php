<?php
	...
	else
	{
		...
		/*LOG-IN FORM*/
	 	if ($_SESSION['ultransaction_promo'] == '') 
		{
			$_SESSION['ultransaction_promo'] = $_SESSION["ulname"];
			$modulename = 'transaction_promo';
...
Status
&nbsp;&nbsp;&nbsp;
<a title="Add a new entry?" href="index.php?body=transaction_promo_addeditdel&mybox=add">
Add Record
</a>											
										</th>
                                    </tr>
...
while ($row_promo =  mysql_fetch_array ($result_promo)) 
{
	...
	print("<td align=\"left\" valign=\"middle\">$row_promo[tpcode] </td>\n");
	...
	print("[ <a title=\"Update entry?\" href=\"index.php?body=transaction_promo_addeditdel&mybox=edit&trid=$row_promo[trid]\"> Update </a> ]"); 
	print("</td>");

	print("<td align=\"CENTER\" valign=\"middle\">");
	print("[ <a title=\"Delete this entry?\" href=\"index.php?body=transaction_promo_addeditdel&mybox=del&trid=$row_promo[trid]\"> Delete </a> ]");
	print("</td>");
