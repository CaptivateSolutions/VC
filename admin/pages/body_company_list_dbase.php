<?php
	...
	{
		/*LOG-IN FORM*/
	 	if ($_SESSION['ulcompany_list'] == '') 
		{
			$_SESSION['ulcompany_list'] = $_SESSION["ulname"];
...
while ($rowdb =  mysql_fetch_array ($resultdb)) 
{
	...
	print("<td align=\"left\" valign=\"middle\">
		<strong>Phone</strong> : $rowdb[cophone] <br> 
		<strong>Email</strong> : $rowdb[coemail] <br>
		<strong>Mobile</strong> : $rowdb[comobile] </td>\n");
	print("<td align=\"left\" valign=\"middle\">
		<strong>Facebook</strong> : $rowdb[cofacebook] <br> 
		<strong>Twitter:</strong> : $rowdb[cotwitter] <br>
		<strong>Instagram</strong> : $rowdb[coinstagram] <br> 
		<strong>Youtube</strong> : $rowdb[coyoutube] </td>\n");
