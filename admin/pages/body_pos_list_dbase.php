<?php
	...
	{
		/*LOG-IN FORM*/
	 	if ($_SESSION['ulpos_list'] == '') 
		{
			$_SESSION['ulpos_list'] = $_SESSION["ulname"];
			$modulename = 'pos_list';
...
?>	
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Position List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<?php
/*									
<form method="post" action="index.php?body=pos_list_dbase">
...
Table Information
									...
									<td align="right">
<a title="Add a new entry?" href="index.php?body=pos_list_addeditdel&mybox=add">
Add Record
</a>
									</td>
								</tr>
...
while ($rowdb =  mysql_fetch_array ($resultdb)) 
{
	...
	print("<td align=\"CENTER\" valign=\"middle\">[ <a title=\"Update entry?\" href=\"index.php?body=pos_list_addeditdel&mybox=edit&plid=$rowdb[plid]\"> Update </a> ] </td>");
	print("<td align=\"CENTER\" valign=\"middle\">[ <a title=\"Delete this entry?\" href=\"index.php?body=pos_list_addeditdel&mybox=del&plid=$rowdb[plid]\"> Delete </a> ] </td>");
