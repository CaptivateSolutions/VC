...
?>	
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Customer List - <?php echo $formtitle; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
Basic Information
									...
									<td align="right">
<a href="index.php?body=customer_list_dbase">
...
?>
					...
					?>						
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
<form role="form" method="post" action="index.php?body=customer_list_addeditdel&mystatus=sent&mybox=<?php print($mybox); ?>&cuid=<?php print($cuid); ?>">

	<div class="form-group">
		<label>Customer Code</label>
		<input class="form-control" name="cucode"  value="<?php print ("$cucode"); ?>"  maxlength="20" >
	</div>
	<div class="form-group">
...
$cuid = $_POST['cuid'];
$cucode = $_POST['cucode'];
$cucode = htmlspecialchars($cucode, ENT_QUOTES);
$cuname = $_POST['cuname'];
...
$cuaddr1 = str_replace('"', '&quot;', $cuaddr1); 
$cuaddr1 = str_replace('\'', '&acute;', $cuaddr1); 
$cuaddr1 = htmlspecialchars($cuaddr1, ENT_QUOTES);

$cuaddr2 = $_POST['cuaddr2'];
$cuaddr2 = str_replace('"', '&quot;', $cuaddr2); 
$cuaddr2 = str_replace('\'', '&acute;', $cuaddr2); 
...
*/
		...
		<HTML> 		
		<meta http-equiv="refresh" content="0;URL=index.php?body=customer_list_dbase">  
		</HTML>
	</div>
                                </div>		
                                <!-- /.col-lg-6 (nested) -->																								
