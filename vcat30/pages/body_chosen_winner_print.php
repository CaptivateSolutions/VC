...
<table class="one" width="800px">
	<tr>
		...
		<br>
		<font size="+1">Chosen Winners for <?php  echo date("m/d/Y", strtotime($globaldate)); ?></font>
...
<?php
	...
	print("<TD ALIGN='CENTER' VALIGN='CENTER' WIDTH='10%' bgcolor='".$grid_bgcolor."'> 
		   <font color='".$grid_fontcolor."'><strong>Issue Branch</strong></font></TD>\n");
	print("<TD ALIGN='CENTER' VALIGN='CENTER' WIDTH='10%' bgcolor='".$grid_bgcolor."'> 
		   <font color='".$grid_fontcolor."'><strong>Raffle Code</strong></font></TD>\n");
	print("<TD ALIGN='CENTER' VALIGN='CENTER' WIDTH='10%' bgcolor='".$grid_bgcolor."'> 
		   <font color='".$grid_fontcolor."'><strong>Register Date</strong></font></TD>\n");
	print("<TD ALIGN='CENTER' VALIGN='CENTER' WIDTH='10%' bgcolor='".$grid_bgcolor."'> 
	...
	print("<TD ALIGN='CENTER' VALIGN='CENTER' WIDTH='10%' bgcolor='".$grid_bgcolor."'> 
		   <font color='".$grid_fontcolor."'><strong>Winning Timestamp</strong></font></TD>\n");
	print("</TR>\n");
	...
	$querydb  = "
			...
			WHERE
				...
				a.tlchosen_date = '$globaldate' and				 
				a.tlactive = 'Y' 
		  	ORDER BY 
				a.tlchosen_stamp ";		
