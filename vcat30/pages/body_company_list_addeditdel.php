...
$coprint1 = $row[coprint1];
$coprint2 = $row[coprint2];
$coevent_minimum = $row[coevent_minimum];
...
<form role="form" method="post" action="index.php?body=company_list_addeditdel&mystatus=sent&mybox=<?php print($mybox); ?>&coid=<?php print($coid); ?>" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label>Minimum Amount for 1 Raffle Code</label>
		<input class="form-control" name="coevent_minimum"  value="<?php print ("$coevent_minimum"); ?>"  maxlength="20" >
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label>POS Print-Out 1st Paragraph</label>
		<textarea class="form-control" rows="4" name="coprint1" ><?php print("$coprint1"); ?></textarea>	
	</div>
	<div class="form-group">
		<label>POS Print-Out 2nd Paragraph</label>
		<textarea class="form-control" rows="4" name="coprint2" ><?php print("$coprint2"); ?></textarea>	
	</div>
...
$coprint1 = $_POST['coprint1'];
$coprint2 = $_POST['coprint2'];
$coevent_minimum = $_POST['coevent_minimum'];
...
coprint1 = '$coprint1',
coprint2 = '$coprint2',
coevent_minimum = '$coevent_minimum',
...
coid = '$coid'";
		...
		//update the master file so that
		//no need to logout anymore  
		if ($mybox != 'del') 
		{
			$_SESSION["coid"] = $coid;
			$_SESSION["coname"] = $coname;
			$_SESSION["coaddr"] = $coaddr;
			$_SESSION["cotel"] = $cotel;
			$_SESSION["cofax"] = $cofax;
			$_SESSION["cowebsite"] = $cowebsite;
			$_SESSION["coemail"] = $coemail;
			
			$_SESSION["coevent_name"] = $coevent_name;
			$_SESSION["coevent_tag"] = $coevent_tag;
			$_SESSION["coevent_logo"] = $coevent_logo;
			$_SESSION["coevent_print"] = $coevent_print;		  
			$_SESSION["coprint1"] = $coprint1;		  
			$_SESSION["coprint2"] = $coprint2;		
			$_SESSION["coevent_minimum"] = $coevent_minimum;		
