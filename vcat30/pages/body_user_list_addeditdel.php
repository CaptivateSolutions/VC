...
$ulprinter = $row[ulprinter];

$ulbranch = $row[ulbranch];
$ulposition = $row[ulposition];
...
<form role="form" method="post" action="index.php?body=user_list_addeditdel&mystatus=sent&mybox=<?php print($mybox); ?>&ulid=<?php print($ulid); ?>" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label>Branch</label>
		<select class="form-control" name="ulbranch" id="ulbranch" >
		<option><?php print($ulbranch); ?></option>
	...
	<div class="form-group">
		...
		<input class="form-control" placeholder="Enter position" name="ulposition"  value="<?php print ("$ulposition"); ?>"  maxlength="50" >
	</div>

	<div class="form-group">
		<label>Printer Name</label>
		<input class="form-control" placeholder="Enter POS printer name" name="ulprinter"  value="<?php print ("$ulprinter"); ?>"  maxlength="50" >
	</div>
...
?>
	...
	<div class="form-group">
		<label>Email</label>
		<input class="form-control" type="email" placeholder="Enter email" name="ulemail"  value="<?php print ("$ulemail"); ?>"   maxlength="50" >
	</div>	
	...
	<div class="form-group">
		<label>Access to Choose Winner?</label>
	...
	<div class="form-group">
		<label>Access to Issue Raffle Code?</label>
	...
	<div class="form-group">
		<label>Access to Raffle Code Details?</label>
...
<?php
if (!file_exists('testing_mode.txt')) 
{
?>
	<input type="hidden" name="ulerase_records" value="<?php print ("$ulerase_records"); ?>" />
<?php
} 
?>							
...
$ulprinter = $_POST['ulprinter'];

$ulbranch = $_POST['ulbranch'];
$ulposition = $_POST['ulposition'];
...
?>		
	...
	<div class="form-group">
		...
		<br />
		<? 
//echo "<br> ulerase_records : " . $ulerase_records;
